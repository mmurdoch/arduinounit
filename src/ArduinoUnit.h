...
#define assertOp(arg1,op,op_name,arg2) do { if (!Test::assertion<__typeof__(ArduinoUnitWiden::value(arg1)),__typeof__(ArduinoUnitWiden::value(arg2))>(F(__FILE__),__LINE__,F(#arg1),(arg1),F(op_name),op,F(#arg2),(arg2))) return; } while (0)
